...
void Fence::defineFence() {
	...
	for (int i = 0; i < NUM_POSTS_PER_SIDE; i++) {
		post[index] = new Block(shaderIF, newPost, ymin, zmin, postWidth, postHeight, postWidth, 1);
		newPost += delta;
		index++;
	}
	...
	newPost = zmin;
	for (int i = 0; i < NUM_POSTS_PER_SIDE; i++) {
		post[index] = new Block(shaderIF, (xmax - postWidth), ymin, newPost, postWidth, postHeight, postWidth, 1);
		newPost += delta;
		index++;
	}
	...
	for (int i = 0; i < NUM_POSTS_PER_SIDE; i++) {
		post[index] = new Block(shaderIF, newPost, ymin, (zmax - postWidth), postWidth, postHeight, postWidth, 1);
		newPost -= delta;
		index++;
	}
	...
	for (int i = 0; i < NUM_POSTS_PER_SIDE; i++) {
		post[index] = new Block(shaderIF, xmin, ymin, newPost, postWidth, postHeight, postWidth, 1);
		newPost -= delta;
		index++;
	}
