...
void House::defineHouse() {
	...
	***********************************/
	...
	//HOUSE TRIM
	trim[0] = new Block(shaderIF, xmax, ymin, zmax, TRIM_DELTA, length, TRIM_DELTA);									//front right vertical trim
	trim[1] = new Block(shaderIF, (xmin - TRIM_DELTA), ymin, zmax, TRIM_DELTA, length, TRIM_DELTA);		//front left vertical trim
	trim[2] = new Block(shaderIF, (xmin - TRIM_DELTA), ymin, zmin - TRIM_DELTA, TRIM_DELTA, length, TRIM_DELTA);		//back left vertical trim
	trim[3] = new Block(shaderIF, xmax, ymin, zmin - TRIM_DELTA, TRIM_DELTA, length, TRIM_DELTA);									//back right vertical trim

	//WINDOW TRIM
	trim[4] = new Block(shaderIF, doorWindowLeft - TRIM_DELTA, windowBottom - TRIM_DELTA, zmax, windowLength + 2 * TRIM_DELTA, TRIM_DELTA, TRIM_DELTA);		//window bottom trim
	trim[5] = new Block(shaderIF, doorWindowLeft - TRIM_DELTA, windowTop, zmax, windowLength + 2 * TRIM_DELTA, TRIM_DELTA, TRIM_DELTA);		//window bottom trim
	trim[6] = new Block(shaderIF, doorWindowLeft - TRIM_DELTA, windowBottom, zmax, TRIM_DELTA, windowLength, TRIM_DELTA);		//window left trim
	trim[7] = new Block(shaderIF, doorWindowRight, windowBottom, zmax, TRIM_DELTA, windowLength, TRIM_DELTA);		//window right trim

	//DOOR TRIM
	trim[8] = new Block(shaderIF, doorWindowLeft - TRIM_DELTA, ymin, zmax, TRIM_DELTA, DOOR_HEIGHT + TRIM_DELTA, TRIM_DELTA);		//left left trim
	trim[9] = new Block(shaderIF, doorWindowRight, ymin, zmax, TRIM_DELTA, DOOR_HEIGHT + TRIM_DELTA, TRIM_DELTA);		//left left trim
	trim[10] = new Block(shaderIF, doorWindowLeft, doorTop, zmax, windowLength, TRIM_DELTA, TRIM_DELTA);		//window bottom trim

	trim[11] = new Block(shaderIF, xmin, yHeight, zmax, length, TRIM_DELTA, TRIM_DELTA);		//top house trim
	trim[12] = new Block(shaderIF, xmin, yHeight, zmin - TRIM_DELTA, length, TRIM_DELTA, TRIM_DELTA);		//top house trim
